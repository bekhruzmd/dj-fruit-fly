...
export default defineConfig({
  ...
  server: { proxy: { '/api/analysis': { target: 'http://127.0.0.1:8765', changeOrigin: true, timeout: 180000, proxyTimeout: 180000 } } },
})

// Module summary: This config serves the interface and forwards analysis requests to Python.
